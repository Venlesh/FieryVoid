<?php
class Posedion extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
		...
		$this->pointCost = 950;
		$this->faction = "EA";
        $this->phpclass = "Posedion";
        $this->imagePath = "img/ships/avenger.png";
        $this->shipClass = "Poseidon Supercarrier";
        ...
        $this->addPrimarySystem(new CnC(6, 24, 0, 1));
        $this->addPrimarySystem(new Scanner(5, 20, 3, 8));
        $this->addPrimarySystem(new Engine(5, 25, 0, 12, 3));
        ...
        $this->addFrontSystem(new MediumPulse(3, 6, 3, 0, 240));
        $this->addFrontSystem(new InterceptorMkIII(2, 6, 3, 240, 0)); 
        $this->addFrontSystem(new InterceptorMkIII(2, 6, 3, 0, 120)); 
        ...
        $this->addAftSystem(new InterceptorMkIII(2, 6, 3, 180, 300)); 
        $this->addAftSystem(new InterceptorMkIII(2, 6, 3, 60, 180));
        ...
        $this->addLeftSystem(new Hangar(4, 12, 12));
        $this->addLeftSystem(new Hangar(4, 12, 12));
        $this->addLeftSystem(new Hangar(4, 12, 12));
        $this->addLeftSystem(new Hangar(4, 12, 12));
		...
		$this->addRightSystem(new Hangar(4, 12, 12));
		$this->addRightSystem(new Hangar(4, 12, 12));
		$this->addRightSystem(new Hangar(4, 12, 12));
		$this->addRightSystem(new Hangar(4, 12, 12));
